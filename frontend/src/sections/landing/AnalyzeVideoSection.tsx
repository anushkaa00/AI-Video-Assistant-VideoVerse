...
export function AnalyzeVideoSection() {
  ...
  const handleAnalyze = () => {
    ...
    console.log({ mode, url, language, file: file?.name })
  }
              ...
              {mode === 'youtube' ? (
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/[0.08] bg-white/[0.04] px-4 py-3.5 text-sm text-white placeholder:text-slate-500 transition-all duration-200 focus:border-accent-blue/40 focus:bg-white/[0.06] focus:outline-none focus:ring-2 focus:ring-accent-blue/20"
                  />
                </div>
              ) : (
                <div>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full appearance-none rounded-xl border border-white/[0.08] bg-white/[0.04] px-4 py-3.5 pr-10 text-sm text-white transition-all duration-200 focus:border-accent-blue/40 focus:bg-white/[0.06] focus:outline-none focus:ring-2 focus:ring-accent-blue/20 cursor-pointer"
                  >
                    {languages.map((lang) => (
                      <option
                        key={lang.value}
